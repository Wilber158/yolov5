...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=200, conv1_stride=1,
                 maxpool1_stride=2,
                 zero_init_residual=False,
                 groups=1, width_per_group=64,
                 replace_stride_with_dilation=None,
                 norm_layer=None, color_channels = 1):
        ...
        #########################################
        #Greyscale - change first arg to 1

        self.conv1 = nn.Conv2d(color_channels, self.inplanes, kernel_size=7,
                               stride=conv1_stride,
                               padding=3,
                               bias=False)
...
def ResNet18(conv1_stride=1, maxpool1_stride=2,  num_classes=200, color_channels=1):
    ...
    return _resnet(BasicBlock, [2, 2, 2, 2], conv1_stride=conv1_stride,
                   maxpool1_stride=maxpool1_stride, num_classes=num_classes, color_channels=color_channels)


def ResNet34(conv1_stride=2, maxpool1_stride=2, num_classes=200, color_channels=1):
...
def ResNet50(conv1_stride=2, maxpool1_stride=2, num_classes=200, color_channels=1):
